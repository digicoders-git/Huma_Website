...
const FloatingContact = () => {
  ...
  return (
    <div className="fixed bottom-8 left-8 z-50 flex flex-col gap-4">
      ...
      <a
        href={`tel:${callNumber}`}
        className="group relative flex items-center justify-center w-14 h-14 bg-[#007bff] text-white rounded-full shadow-2xl hover:scale-110 transition-all duration-300"
        title="Call Us"
      >
        <Phone size={26} strokeWidth={2.2} />
        <span className="absolute left-full ml-3 px-3 py-1.5 bg-[#007bff] text-white text-[10px] font-bold uppercase tracking-widest rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 whitespace-nowrap shadow-xl">
          Call Now
        </span>
      </a>
